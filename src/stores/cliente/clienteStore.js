...
import { home, cash, mailOutline, locate, shieldCheckmark, ribbonSharp, cardOutline, bag } from 'ionicons/icons';
    ...
    state: () => ({
        ...
        appPages: [
            ...
            },
            {
                ...
                url: '/cliente/payment-method',
                iosIcon: cardOutline,
                mdIcon: cardOutline
            },
            {
                title: 'Direcciones de envio',
                url: '/cliente/direccion-envio',
                iosIcon: bag,
                mdIcon: bag
            },
            {
